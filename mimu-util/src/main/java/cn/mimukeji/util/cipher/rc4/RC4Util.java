package cn.mimukeji.util.cipher.rc4;
...
public class RC4Util {
    ...
    public static void main(String[] args) {
            String data = "这个是RC4算法。This is RC4.";
            String key = "3EDC4RFV,ki87ujm";
            String charSet = "utf-8";

        try {
            String oriData = data;
            String destData = "";
            destData = encryRC4String(oriData,key,charSet);
            System.out.println(destData);

            System.out.println(decryRC4(destData,key,charSet));
